...
%-----------------------------------------------------
\begin{table*}[tp]
\inputminted[ fontsize=0.5\footnotesize, baselinestretch=0.5, frame=lines, framesep=2mm ]{python}{figures/arrayToQPath_condensed.py}
