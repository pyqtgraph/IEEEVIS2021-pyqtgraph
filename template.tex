...
\usepackage{minted}% syntax higlighting
\usepackage{verbatim}
...
%\item Nils Nemitz is with the National Institute for Information and Communications Technology, Japan.  E-mail: nils.nemitz@gmx.de
...
\subsubsection{Performance}
% Martin and\or Nathan - discuss makeqimage, also a good opportunity to discuss CUDA support
...
def arrayToQPath(x, y, connect='all'):
    ...
    return path
\end{minted}
\caption{PyQtGraph source code for the core \emph{arrayToQPath} function.}
